...
var artDialog = function (config, ok, cancel) {
    ...
    artDialog.defaults.closeOnEscape = config.closeOnEscape;

    console.log(artDialog.defaults)
...
$(document).bind('keydown', function (event) {
    ...
    if (!api || !artDialog.defaults.closeOnEscape || rinput.test(nodeName) && target.type !== 'button') {
        return;
    };
...
;
(function (d) {
    var options = d.dialog.defaults;
    options['okValue'] = '确定';
    options['cancelValue'] = '取消';
    options['title'] = '消息';
    options['lock'] = true;
    // [more..]
